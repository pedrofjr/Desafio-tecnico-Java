...
class CupomIntegrationTest {
    ...
    @Test
    @DisplayName("[19] POST /coupon com dados validos deve retornar 201 e body correto")
    ...
    @Test
    @DisplayName("[19b] POST /coupon com published=true deve retornar published=true")
    ...
    @Test
    @DisplayName("[20] POST /coupon com expirationDate passada deve retornar 422")
    ...
    @Test
    @DisplayName("[20b] POST /coupon com expirationDate = hoje deve retornar 422")
    ...
    @Test
    @DisplayName("[21] POST /coupon com discountValue < 0.5 deve retornar 422")
    ...
    @Test
    @DisplayName("[21b] POST /coupon com discountValue = 0.5 deve retornar 201")
    ...
    @Test
    @DisplayName("[21c] POST /coupon com discountValue negativo deve retornar 400 (Bean Validation)")
    ...
    @Test
    @DisplayName("[22] POST /coupon com code contendo especiais deve retornar code sanitizado")
    ...
    @Test
    @DisplayName("[23] DELETE /coupon/{id} para cupom existente deve retornar 204")
    ...
    @Test
    @DisplayName("[24] DELETE /coupon/{id} apos soft-delete deve retornar 4xx")
    ...
    @Test
    @DisplayName("GET /coupon/{id} para cupom existente deve retornar 200")
    void getCouponById_idExistente_deveRetornar200() throws Exception {
        ...
        mockMvc.perform(get("/coupon/{id}", cupom.getId()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value("GET001"));
    }

    @Test
    @DisplayName("GET /coupon/{id} para id inexistente deve retornar 404")
    void getCouponById_idInexistente_deveRetornar404() throws Exception {
        mockMvc.perform(get("/coupon/{id}", "id-que-nao-existe"))
                .andExpect(status().isNotFound());
    }

    @Test
    @DisplayName("POST /coupon com code em branco deve retornar 400 (Bean Validation)")
    ...
    @Test
    @DisplayName("POST /coupon sem body deve retornar 4xx")
